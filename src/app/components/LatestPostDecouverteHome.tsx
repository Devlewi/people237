...
type LatestPostDecouverteHomeProps = {
  articlesdecouvertes: Article[];
};

const LatestPostDecouverteHome: React.FC<LatestPostDecouverteHomeProps> = ({
  articlesdecouvertes,
}) => {
  return (
    <>
      ...
      >
        ...
        <div className="block-content">
          <div className="loop loop-grid loop-grid-base grid grid-2 md:grid-2 xs:grid-1">
            {articlesdecouvertes.map((article) => (
              <article
...
export default LatestPostDecouverteHome;
