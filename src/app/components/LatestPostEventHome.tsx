...
type LatestPostEventHomeProps = {
  articlesevent: Article[];
};

const LatestPostEventHome: React.FC<LatestPostEventHomeProps> = ({
  articlesevent,
}) => {
      ...
      <div className="block-head block-head-c is-left">
        <h4 className="heading" style={{ fontSize: 25 }}>
          <span className="color">
            <i className="typcn typcn-calendar" style={{ fontSize: 30 }} />{" "}
            Event
          </span>
        </h4>
      </div>
