...
type LatestPostPeopleHomeProps = {
  articlespeople: Article[];
};

const LatestPostPeopleHome: React.FC<LatestPostPeopleHomeProps> = ({
  articlespeople,
}) => {
        ...
        <div className="block-head block-head-c is-left">
          <h4 className="heading" style={{ fontSize: 25 }}>
            <span className="color">
              <i className="typcn typcn-news" style={{ fontSize: 30 }} /> People
            </span>{" "}
          </h4>
        </div>
