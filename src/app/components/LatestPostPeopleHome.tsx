                                      ...
                                      <div className="content">
                                        <div className="post-meta post-meta-a has-below">
                                          <h2 className="is-title post-title">
                                            ...
                                            >
                                              L’acteur Hervé Nguetch n’est plus
                                              un coeur à prendre
                                            </Link>
                                          </h2>
                                        ...
                                        <div className="excerpt">
                                          <p>
                                            Il a célébré son mariage
                                            traditionnel ce weekend du côté de
                                            l&apos;Ouest Cameroun. C&apos;est vraiment la
                                            saison des mariages en ce moment,
                                            même chez les…
                                          </p>
                                        </div>
                                      </div>
...
<span className="cat-labels cat-labels-overlay c-overlay p-bot-left">
                                      ...
                                      <div className="content">
                                        <div className="post-meta post-meta-a has-below">
                                          <h2 className="is-title post-title">
                                            <Link
                                              ...
                                              className="post-title-2"
                                            >
                                              Vanister célèbre sa fiancée pour
                                              sa fidélité en couple
                                            </Link>
                                          </h2>
                                          <div className="post-meta-items meta-below">
                                            <span className="meta-item post-author">
                                        ...
                                        <div className="excerpt">
                                          <p>
                                            Vanister toujours prêt à vanter sa
                                            copine, ses qualités et clamer haut
                                            et fort son amour pour elle a encore
                                            frappé. &apos;artiste cette fois met…
                                          </p>
                                        </div>
                                      </div>
                                    </article>
...
<span className="cat-labels cat-labels-overlay c-overlay p-bot-left">
                                      ...
                                      <div className="content">
                                        <div className="post-meta post-meta-a has-below">
                                          <h2 className="is-title post-title">
                                            <Link
                                              ...
                                              className="post-title-2"
                                            >
                                              Nguemgaing Rosine: succès total
                                              pour son film{" "}
                                            </Link>
                                          </h2>
                                          <div className="post-meta-items meta-below">
                                        ...
                                        <div className="excerpt">
                                          <p>
                                            &apos;avant première de classe à part à
                                            eu lieu ce 26 décembre 2024. Tout le
                                            monde est conquis par cette
  ...
  export default LatestPostPeopleHome;