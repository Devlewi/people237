...
type LatestPostVideoHomeProps = {
  articlevideo: Article[];
};

const LatestPostVideoHome: React.FC<LatestPostVideoHomeProps> = ({
  articlevideo,
}) => {
  return (
    <>
                ...
                <div className="post-meta post-meta-a has-below">
                  ...
                  <div className="post-meta-items meta-below">
                    <span className="meta-item post-author">
                      ...
                      <Link href="#" title="Posts by Shane Doe" rel="author">
                      <i
