...
type LatestPostPeopleCamerHomeProps = {
  articlespeoplecamer: Article[];
};

const LatestPostPeopleCamerHome: React.FC<LatestPostPeopleCamerHomeProps> = ({
  articlespeoplecamer,
}) => {
    ...
    <>
      ...
      >
        ...
        <div className="block-content">
          ...
          {articlespeoplecamer.map((article) => (
...
export default LatestPostPeopleCamerHome;
